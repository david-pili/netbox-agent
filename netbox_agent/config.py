...
def get_config():
    ...
    p.add_argument("--rack_position.driver", help="Rack position driver, ie: cmd, file")
    p.add_argument("--rack_position.driver_file", help="Rack position custom driver file path")
    p.add_argument("--rack_position.regex", help="Rack position regex to extract Rack name")
